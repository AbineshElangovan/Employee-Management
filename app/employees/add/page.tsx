...
const employeeSchema = z.object({
  ...
  salary: z.number().gt(0, "Salary parameter metric must be greater than 0"),
                          ...
                          <div className="space-y-3">
                            {imagePreview? (
                              ...
                              <label
                                ...
                                className={`flex flex-col items-center justify-center w-32 h-32 border-2 border-dashed rounded-lg cursor-pointer hover:bg-muted/50 ${
