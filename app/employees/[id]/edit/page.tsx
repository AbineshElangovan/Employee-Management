...
import { getEmployee, updateEmployee } from "@/lib/db-actions"
...
export default function EmployeeEditPage() {
  ...
  const { updateEmployee: updateStore } = useEmployeeStore()
  ...
  const form = useForm<EditForm>({
    ...
    defaultValues: {
      ...
      joiningDate: "", salary: 0, status: "active",
      attendancePercentage: 0, imageUrl: "",
    },
  })
  ...
  useEffect(() => {
    ...
    getEmployee(id)
      .then((data) => {
        if (!data) { toast.error("Employee not found"); return }
        form.reset({
                  ...
                  <FormField control={form.control} name="department" render={({ field }) => (
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} value={field.value}>
                        ...
                        <SelectContent>
                          {["Development","Sales","HR","Marketing","Finance","Design"].map(d => (
